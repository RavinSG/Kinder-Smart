        ...
        <form class="col s12" action="register.admin.php" method="post">
            ...
            <div class="row">
                <div class="input-field col s12">
                    ...
                    <input id="address" type="text" name="address" required pattern="[a-zA-Z0-9']+[a-zA-Z0-9'/-,()& ]+" class="validate" value= <?php if(isset($_SESSION['admin_address'])){echo "{$_SESSION['admin_address']}";} else{echo "";}?> >
