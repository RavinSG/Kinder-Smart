			...
			<form class="col s12" action="register.parent.php" method="post">
			  ...
			  <div class="row">
		        ...
		        <div class="input-field col s6">
		          ...
		          <input id="address" type="text" name="address" required pattern="[a-zA-Z0-9']+[a-zA-Z0-9'/-,()& ]+" class="validate" value= <?php if(isset($_SESSION['parent_address'])){echo "{$_SESSION['parent_address']}";} else{echo "";}?> >
